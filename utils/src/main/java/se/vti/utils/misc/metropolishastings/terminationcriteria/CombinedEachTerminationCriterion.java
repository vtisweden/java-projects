 ...
 * @author MichaelS
 */
public class CombinedEachTerminationCriterion<X> extends AbstractCombinedTerminationCriterion<X> {

	public CombinedEachTerminationCriterion(TerminationCriterion<X> tc) {
		super(tc);
	}
